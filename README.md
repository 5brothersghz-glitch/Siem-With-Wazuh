...
## Step 8: Install Ollama for AI-Assisted Log Analysis

To enhance log analysis capabilities, I installed Ollama on the Ubuntu server to run a local large language model (LLM) for AI-assisted cybersecurity investigations. I created a shell script to quickly launch Ollama and load the AI model used for security log analysis.

Using Ollama, I analyzed Wazuh and Sysmon logs generated during MITRE Caldera attack simulations. The AI assisted in summarizing alerts, identifying indicators of compromise (IOCs), explaining suspicious activity, and providing additional context for incident investigations.

This integration improved the efficiency of reviewing security events and demonstrated how AI can support Security Operations Center (SOC) workflows by accelerating log analysis and threat investigation.
...
![Shell Script](images/ollama-script.png)
